...
class AreaController
{
    ...
    public function create()
    {
        ...
        if ($method == 'POST') {
            ...
            $cod_archivistico = isset($_POST['cod_archivistico']) ? trim(strtoupper($_POST['cod_archivistico'])) : false;
            ...
            if ($nombre && $cod_archivistico && $idUser) {
                $data = new $this->table();
                $data->setNombre($nombre);
                $data->setCodArchivistico($cod_archivistico);
                ...
                $response = array();
                $response[] = ['error' => "nombre,cod_archivistico and idUser are Requiredes"];
            }
        } else {
            $response = array();
